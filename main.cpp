...
int main()
{
	...
	string presolveStr = generatePresoveSplitted(graph9, 3);
	ofstream f("presolve9r_split.mst");
	f << presolveStr;
	f.flush();
	f.close();*/

	/*UndirectedGraph graph9 = loadGraphFromSCIPSolution("solution24.txt", 24);
